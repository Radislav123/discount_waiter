...
ADD_SITE__INPUT_LOGIN_TEMPLATE = "Введите Ваш логин на выбранном сайте ({site_name})."
ADD_SITE__INPUT_PASSWORD_TEMPLATE = "Введите Ваш пароль на выбранном сайте ({site_name})."
...
ADD_ITEM__NOT_FOUND_INFORMATION_TEXT = f"Бот не нашел необходимой информации на странице вещи.\n" \
